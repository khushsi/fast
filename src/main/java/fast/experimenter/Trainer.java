...
//			StudentList curKcTestStuList = testKcsStuLists.get(curKcTestId);
            ...
            if (opts.nbRandomRestart <= 1)
                bestRestartLogger = trainOneHMMOneRestart(fileId, 0, hmmId, hmmName, curKcTrainStuList, trainKcs);
            else
    ...
    public OneRestartLogger trainOneHMMOneRestart(int fileId, int restartId, int hmmId, String hmmName,
                                                  StudentList curKcTrainStuList, Bijection trainHMMs) throws IOException {
